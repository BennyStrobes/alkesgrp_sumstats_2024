...
trait1_identifier="GBMI_AbdominalAorticAneurysm"
trait2_identifier="PASS_FetalBirthWeight_Warrington2019"
...
python ${ldsc_code_dir}ldsc.py --rg ${gwas_trait1_file_name}","${gwas_trait2_file_name} --no-check-alleles --ref-ld-chr ${ldscore_hg19_dir} --w-ld-chr ${sldsc_h19_weights_dir} --out ${ldsc_rg_results_dir}${trait1_identifier}":"${trait2_identifier}"_2021_debugger_rg"
...
echo $gwas_trait1_file_name
echo $gwas_trait2_file_name


# LDSC genetic correlation (rg) command
python ${ldsc_code_dir}ldsc.py --rg ${gwas_trait1_file_name}","${gwas_trait2_file_name} --no-check-alleles --ref-ld-chr ${ldscore_hg19_dir} --w-ld-chr ${sldsc_h19_weights_dir} --out ${ldsc_rg_results_dir}${trait1_identifier}":"${trait2_identifier}"_2024_debugger_rg"
fi
